      ...
      <div className="w-full max-w-4xl mx-auto space-y-6 animate-in fade-in duration-500">
          ...
          <CardHeader className="flex flex-row items-start sm:items-center justify-between gap-2 px-0 pt-0">
              <div className="flex-1">
                  ...
                  <CardDescription className="text-base font-medium">
                    Monitoring local broadcasts and surrounding hazards.
                  </CardDescription>
              </div>
                    ...
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <AlertDialogTrigger asChild>
                          <Button variant="outline" size="icon" className="text-destructive hover:bg-destructive hover:text-white transition-all" disabled={isLoading || isDeleting || (processedAlerts.length === 0 && !isLoading)}>
          ...
          <CardContent className="px-0 pt-4">
              ...
              {isLoading ? (
                  ...
                  <div className="text-center py-20 bg-card rounded-2xl border-2 border-dashed border-muted flex flex-col items-center gap-4 animate-in fade-in zoom-in-95 duration-500">
